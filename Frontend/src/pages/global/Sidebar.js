...
import logoDashboard from '../../images/IMG1project.png'
import { Link } from 'react-router-dom';
import { useDispatch, useSelector } from 'react-redux';
import { userLogoutAction, userProfileAction } from '../../Redux/Actions/userAction';
import { useNavigate } from 'react-router-dom';
import LoginIcon from '@mui/icons-material/Login'; // from MUI
...
const SidebarAdm = () => {
    ...
    return (
        <>
            <Sidebar backgroundColor="#795548" style={{ borderRightStyle: "none" }}>
                        ...
                        >
                            {
                                ...
                                userInfo && userInfo.role === 1 ?
                                    <>
                                        ...
                                        <MenuItem component={<Link to="/admin/category" />} icon={<Person3Icon />}> Category </MenuItem>
                                        <MenuItem component={<Link to="/" />} icon={<CategoryIcon />}> Home Page </MenuItem>
                                    </> :
                                    <>
